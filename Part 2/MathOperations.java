public class MathOperations {
    public static void main(String[] args) {
        ...
        System.out.println("There are " + (starsInAndromeda + starsInTheMilkyWay)
                + " stars in the Milky Way and Andromeda galaxies.");

        System.out.println(
                "With bonus marks, Ron scored " + (testScore + bonusMarks)
        ...
        System.out.println("The Andromeda Galaxy has " + (starsInAndromeda - starsInTheMilkyWay)
                + " more stars than the Milky Way");
        System.out.println("Snape ended up removing marks. Ron actually scored " + (testScore - bonusMarks)
                + " on his potions test");
        System.out.println(
